...
try:
    # streamlit-drawable-canvas usa internamente streamlit.elements.image.image_to_url.
    # En Streamlit reciente esa función fue movida; este parche evita el AttributeError
    # y, si no alcanza, la app cae a modo seguro sin detenerse.
    try:
