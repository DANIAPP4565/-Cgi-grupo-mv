...
def canvas_select_rois(img: Image.Image, rois_default: dict, key_prefix: str = "roi_canvas") -> dict:
    ...
    st.warning("Para mover bordes directamente sobre la imagen instale `streamlit-drawable-canvas`. Mientras tanto se muestran campos numéricos de bordes, no barras.")
    rois = {}
