...
# ============================================================
# BLOQUES SEGUROS SIN EXPANDERS
# ============================================================
# Streamlit no permite expanders anidados. Para evitar errores cuando
# una sección se llama dentro de otra, toda sección plegable se muestra
# como contenedor normal con título.
...
def login_ui() -> None:
    ...
    with t1:
        ...
        with c2:
            ...
            if not admin_exists():
                with safe_expander("Crear administrador inicial", expanded=True):
    ...
    with tab1:
        ...
        if uploaded is not None:
            try:
                ...
                with safe_expander("Texto extraído del PDF", expanded=False):
                    if text.strip():
    ...
    with tab2:
        ...
        if uploaded2 is not None or use_last:
            try:
                ...
                with safe_expander("Seleccionar sectores gráficos moviendo bordes", expanded=True):
                ...
                if dzdt.empty:
                    ...
                    with safe_expander("Mover cursores directamente sobre el gráfico", expanded=True):
                    ...
                    with safe_expander("Respaldo numérico opcional", expanded=False):
